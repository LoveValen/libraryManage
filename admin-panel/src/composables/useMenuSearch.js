...
export function useMenuSearch() {
  ...
  const searchHistory = ref(JSON.parse(localStorage.getItem('menu_search_history') || '[]'))
  ...
  const addToSearchHistory = (result) => {
    ...
    // 保存到localStorage
    localStorage.setItem('menu_search_history', JSON.stringify(searchHistory.value))
  }
  ...
  const clearSearchHistory = () => {
    searchHistory.value = []
    localStorage.removeItem('menu_search_history')
  }
