...
import { ElMessage, ElMessageBox, ElInput, ElIcon, ElButton, ElProgress, ElUpload } from 'element-plus'
import { 
  CircleCheck, 
  CircleClose, 
  ArrowLeft, 
...
const AvatarUploadField = {
  ...
  setup() {
    return () => h('div', { class: 'avatar-upload-field' }, [
      h(ElUpload, {
        ...
        default: () => {
          if (formData.avatar && !uploading.value) {
            ...
            return h(ElIcon, { class: 'avatar-uploader-icon' }, {
              default: () => h(Plus)
            })
          }
        }
      ...
      h('div', { class: 'upload-tips' }, [
        ...
        formData.avatar && h('div', { class: 'avatar-actions' }, [
          h(ElButton, {
            size: 'small',
            type: 'primary',
            link: true,
            ...
            default: () => [
              h(ElIcon, null, { default: () => h(ZoomIn) }),
              ' 预览'
            ]
          }),
          h(ElButton, {
...
const PasswordFieldWithStrength = {
  ...
  setup(props) {
    return () => h('div', [
      ...
      props.value && h('div', { class: 'password-strength' }, [
