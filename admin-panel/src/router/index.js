...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'books',
        name: 'AnalyticsBooks',
        component: () => import('@/views/analytics/books.vue'),
        meta: {
          title: '图书分析',
          icon: 'Reading'
        }
      ...
      },
      {
        ...
        component: () => import('@/views/analytics/insights.vue'),
        meta: {
          title: '智能洞察',
          icon: 'DataAnalysis'
        }
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'books',
        name: 'StatisticsBooks',
        component: () => import('@/views/statistics/books.vue'),
        meta: {
          title: '图书统计',
          icon: 'Reading'
        }
      ...
      {
        path: 'borrows',
        name: 'StatisticsBorrows',
        component: () => import('@/views/statistics/borrows.vue'),
        meta: {
          title: '借阅统计',
          icon: 'DocumentCopy'
        }
